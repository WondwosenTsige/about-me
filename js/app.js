...
// for( var i = 0 ; i < 6 ; i++ ) {
//     for( var j = 0 ; j < favoritePlacesToVisit.length ; j++ ) {

//     if(guessPlacesToVisit === favoritePlacesToVisit[j]){
//         alert ('You got it right! the whole  lists of places I want to visit are '+ favoritePlacesToVisit);
//         rightAnswerCounter++;
//         i = 6;
//         break;
//     }else if( i === 5 ){
//         guessPlacesToVisit = prompt ('No! '+ favoritePlacesToVisit+ 'is the list of places I want to visit');
//         break;
//     }else if( i === 4 ){
//         guessPlacesToVisit = prompt ('Sorry. That\'s wrong ' + userName + '. You only have one guess left.');
//     }else {
//         guessPlacesToVisit = prompt ('Wrong. Try again.');
//     }
